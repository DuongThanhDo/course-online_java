...
/**
 * Servlet implementation class courseStudentContent
 */
@WebServlet("/student/course/content")
public class courseStudentContent extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(strCourse_id != null) {
				...
				if(time != null) {
					request.setAttribute("TimeVideo", time);
				}
				else if(note != null) {
					request.setAttribute("OpenNote", note);
				}
				...
				request.setAttribute("Notes", nobo.getNotes(user_id, course_id));
				...
				RequestDispatcher rd = request.getRequestDispatcher("/student/pages/my-course-detail.jsp");
