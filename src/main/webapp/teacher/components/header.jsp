...
<nav class="navbar navbar-expand-sm header-nav navbar-dark">
	<div class="container">
		<a class="navbar-brand"
			href="${pageContext.request.contextPath}/teacher/home"><h3>Giảng
			viên</h3></a>
		...
		<div class="collapse navbar-collapse" id="collapsibleNavbar">
			<ul class="navbar-nav me-auto">
				<li class="nav-item"><a class="nav-link"
					href="${pageContext.request.contextPath}/teacher/home">Trang
						chủ</a></li>
				<li class="nav-item"><a class="nav-link"
					href="${pageContext.request.contextPath}/teacher/course">Quản
						lý khóa học</a></li>
				<li class="nav-item"><a class="nav-link"
					href="${pageContext.request.contextPath}/teacher/manager-student">Học
						viên đăng ký</a></li>
			</ul>
			<ul class="navbar-nav me-2">
				...
				if (!sttLogin) {
				%>
				<!-- <li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/teacher/notification"><i class="fa-solid fa-bell"></i> Thông báo</a></li> -->
				<div class="dropdown dropstart"
					...
					<ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
						<li><a class="dropdown-item"
							href="${pageContext.request.contextPath}/teacher/profile">Thông
								tin cá nhân</a></li>
