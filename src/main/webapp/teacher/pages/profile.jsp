...
<body>
	...
	<div class="container mt-4">
		<form action="${pageContext.request.contextPath}/teacher/profile/save"
					...
					<c:if test="${edit}">
						<div class="input-group mb-3">
							<input type="file" name="uploadPhoto" accept="image/*"
								class="input-group-text" value="${profile.profile_picture_url }"
					...
					<div class=" d-flex flex-column align-items-end gap-2">
						...
						<div class="input-group mb-3">
							<span class="input-group-text">Ngày sinh</span> <input
								...
								value="${profile.date_of_birth }" ${edit ? "" : "disabled"} />
						</div>
						...
						<c:choose>
							<c:when test="${!edit}">
								<a
									href="${pageContext.request.contextPath}/teacher/profile?action=EDIT"
							...
							<c:otherwise>
								<div class="d-flex align-items-center gap-4">
									<button type="submit" class="btn btn-success">Lưu thay
										đổi</button>
									<a
										href="${pageContext.request.contextPath}/teacher/profile?action=CANCEL"
