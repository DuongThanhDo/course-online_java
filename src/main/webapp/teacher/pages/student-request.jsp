...
<body>
	...
	<div class="container mt-4">
		<div
			...
			<form
				action="${pageContext.request.contextPath}/teacher/manager-student"
				method="post">
			...
			<tbody>
				<c:forEach var="rc" items="${RegisterCourses }">
					<tr>
						...
						<td>${rc.title }</td>
						<td class="text-center">${rc.created_at }</td>
						<td class="text-center"><a
							href="${pageContext.request.contextPath}/teacher/manager-student?accept=${rc.id }"
							class="btn btn-success btn-action">Chấp Nhận</a> <a
							href="${pageContext.request.contextPath}/teacher/manager-student?reject=${rc.id }"
							class="btn btn-danger btn-action">Từ Chối</a></td>
					</tr>
				</c:forEach>
				<c:if
							...
							<c:choose>
								...
								<c:otherwise>
									<li class="page-item"><a class="page-link"
										href="${pageContext.request.contextPath}/teacher/manager-student?page=${p}&search=${searchValue}">${p}</a>
									</li>
								</c:otherwise>
							</c:choose>
						</c:forEach>
